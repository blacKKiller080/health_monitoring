...
const Radius _kSeparatorRadius = Radius.circular(100);
...
class CustomSwitchButton<T> extends StatefulWidget {
  CustomSwitchButton({
    super.key,
...
class _SegmentedControlState<T> extends State<CustomSwitchButton<T>>
    with TickerProviderStateMixin<CustomSwitchButton<T>> {
  ...
  @override
  void didUpdateWidget(CustomSwitchButton<T> oldWidget) {
    super.didUpdateWidget(oldWidget);
